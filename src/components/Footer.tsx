    ...
    <footer className="bg-[#0b0e15] dark:bg-[#0b0e15] border-t border-[#161a22] mt-auto">
      <div className="flex flex-col md:flex-row justify-between items-center w-full px-8 py-12 gap-6 max-w-screen-2xl mx-auto">
        <div className="flex flex-col gap-4">
          <span className="text-lg font-bold text-[#eff0fa] font-headline">Digital Curator</span>
          <p className="font-['Inter'] text-xs text-[#a9abb4] max-w-xs">Your premier destination for discovering world-class gaming experiences curated by the community.</p>
        </div>
        ...
        <div className="flex flex-col items-end gap-4">
          ...
          <p className="font-['Inter'] text-xs text-[#a9abb4]">© 2024 Digital Curator. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
